...
# Sidebar inicial com seleção de jogador ou partida
select_mode = st.sidebar.selectbox('Quero ver dados e videos de:', ['Um jogador', 'Uma partida'])

# If condition para seleção de uma partida
